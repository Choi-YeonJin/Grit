//
//  teacherStatusViewController.swift
//  Grit
//
...
class teacherStatusViewController: UIViewController {

    @IBOutlet weak var monthPay: UILabel!
    
    override func viewDidLoad() {
        super.viewDidLoad()
        tabbar_start()
        
        monthPay.backgroundColor = UIColor(patternImage: UIImage(named: "paybackground")!)
        
        monthPay.contentMode = .scaleAspectFit
    }
