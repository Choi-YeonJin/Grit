...
class threeGradient: UIView {
    ...
    override func draw(_ rect: CGRect) {
        ...
        gradientLayer.colors = [UIColor(red: 94/255, green: 183/255, blue: 141/255, alpha: 1.0).cgColor,UIColor(red: 220/255, green: 145/255, blue: 34/255, alpha: 1.0).cgColor ]
